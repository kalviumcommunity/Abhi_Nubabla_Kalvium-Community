...
class RuntimeDocumentUploader:
    ...
    def __init__(
        ...
        self.vector_store_path = vector_store_path or Path("data/embedded_chunks.json")
    ...
    def _sync_vector_store_to_disk(self, new_records: List[Dict[str, Any]]) -> None:
        """Appends new records to data/embedded_chunks.json on disk atomically."""
        try:
...
def run_runtime_searchability_demo(
    ...
    export_path = export_dir or Path("data")
