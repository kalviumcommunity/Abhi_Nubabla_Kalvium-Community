...
def generate_markdown_report(result, query, output_path: str = "data/context_injection_demo_report.md"):
...
def generate_json_results(result, output_path: str = "data/context_injection_demo_results.json"):
