...
def generate_markdown_report(result, output_path: str = "data/reranking_demo_report.md"):
...
def generate_json_results(result, output_path: str = "data/reranking_demo_results.json"):
