...
Options:
    --data PATH            Path to embedded chunks JSON (default: data/embedded_chunks.json)
    --output-json PATH     Path to export results JSON (default: data/retrieval_evaluation_results.json)
    --output-report PATH   Path to export markdown report (default: data/retrieval_evaluation_report.md)
