...
**Run Timestamp**: `2026-09-10T14:20:01.108343`  
**Vector Store**: `data/results/embedded_chunks.json` (25 chunks indexed)  
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| `query_pto_rollover` | **1** | 1 | **0.4802** | 0.4802 | 0.0000 | 79 | `employee_benefits.md` |
| `query_pto_rollover` | **3** | 3 | **0.4802** | 0.2140 | 0.2662 | 219 | `employee_benefits.md` |
| `query_pto_rollover` | **5** | 5 | **0.4802** | 0.1735 | 0.3067 | 366 | `employee_benefits.md` |
...
##### Rank 1: `employee_benefits_chunk_001` (Score: **0.4802**)
...
- **JSON Query Results**: `data/results/similarity_search_results.json`
- **Markdown Retrieval Report**: `data/results/similarity_search_report.md`
