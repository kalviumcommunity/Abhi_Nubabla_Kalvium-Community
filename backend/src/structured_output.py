...
- Task 5: Commit with sample parsed results (see data/results/structured_output_results.json).
"""
...
def run_structured_output():
    ...
    then saves all results to data/results/structured_output_results.json.
    """
