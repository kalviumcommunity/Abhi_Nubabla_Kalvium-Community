...
def process_corpus_embeddings(
    input_chunks_path: str = "data/results/ingested_chunks.json",
    output_json_path: str = "data/results/embedded_chunks.json",
    output_report_path: str = "data/results/embedding_generation_report.md",
    dimension: int = 1536,
    batch_size: int = 16,
    max_retries: int = 3,
    initial_retry_delay: float = 1.0,
...
def main():
    ...
    parser.add_argument("--input", type=str, default="data/results/ingested_chunks.json", help="Path to prepared corpus JSON chunks")
    parser.add_argument("--output-json", type=str, default="data/results/embedded_chunks.json", help="Path for output embedded chunks JSON")
    parser.add_argument("--output-report", type=str, default="data/results/embedding_generation_report.md", help="Path for output markdown report")
