...
def process_vector_indexing(
    input_embedded_path: str = "data/results/embedded_chunks.json",
    collection_output_path: str = "data/results/indexed_collection.json",
    summary_json_path: str = "data/results/vector_indexing_results.json",
    report_md_path: str = "data/results/vector_indexing_report.md",
...
def main():
    ...
    parser.add_argument("--input", type=str, default="data/results/embedded_chunks.json", help="Path to embedded chunks JSON")
    parser.add_argument("--collection-output", type=str, default="data/results/indexed_collection.json", help="Path for output indexed collection JSON")
    parser.add_argument("--summary-json", type=str, default="data/results/vector_indexing_results.json", help="Path for summary JSON dataset")
    parser.add_argument("--report-md", type=str, default="data/results/vector_indexing_report.md", help="Path for output markdown report")
