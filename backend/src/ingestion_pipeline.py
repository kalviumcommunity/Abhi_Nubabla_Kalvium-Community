...
def generate_markdown_report(
    ...
    lines.extend(
        [
            ...
            "",
            "- **Structured Ingestion Summary**: `data/results/ingestion_summary.json`",
            "- **Full Tagged Chunks Store**: `data/results/ingested_chunks.json`",
            "- **Reviewer Audit Report**: `data/results/ingestion_report.md`",
        ]
    )
