...
import { Eye, EyeOff, ShieldCheck, ShieldAlert, ArrowLeft } from "lucide-react";
      ...
      <div className="relative z-10 w-full max-w-[440px] bg-white rounded-3xl p-8 sm:p-10 shadow-xl border border-slate-100/80">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 border border-blue-200/80 text-blue-700 text-xs font-bold uppercase tracking-wider">
